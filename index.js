...
const GOOGLE_SHEET_ID = '1CAuLq4jFILog_Jj2cteA58gVA7108cyKvTMove4N21g';  // Укажите ID вашей таблицы
const GOOGLE_SHEET_RANGE = 'Sheet1!A1';  // Укажите диапазон для записи данных в таблицу
...
async function writeToGoogleSheet(data) {
    const auth = new google.auth.GoogleAuth({
        keyFile: 'dcontact_sheet.json',  // Путь к вашему файлу сервисного аккаунта
...
// Основная логика
async function main() {
    const username = generateUniqueUsername();  // Генерация уникального имени пользователя
